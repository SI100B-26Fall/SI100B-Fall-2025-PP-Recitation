...
直接push你的更新，等待渲染，几分钟之后你的slides会在 https://si100b-26fall.github.io/SI100B-Fall-2026-PP-Recitation/ 出现。

### 本地预览

本地预览需要预先安装 Nix 环境，然后在终端中执行以下命令。

```bash
git clone https://github.com/SI100B-26Fall/SI100B-Fall-2026-PP-Recitation.git
cd SI100B-Fall-2026-PP-Recitation
nix build
```
...
> This document is written by Yuhan Cao. The workflow is developed by Hengyu Ai, Zebang He and Hao Chen. This project is modified by Coinred5965 for SI100B 2026 Fall. Many thanks for their contribution.
